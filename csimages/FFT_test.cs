...
namespace Fast_Fourier_Transform
{
    ...
    internal class FFT
    {
        ...
        private readonly int nx; //Number of Points in Width & height
        private readonly int ny; //Number of Points in Width & height
...
//            Bitmap image = Obj;
            BitmapData bitmapData = Obj.LockBits(new Rectangle(0, 0, Obj.Width, Obj.Height),
                ImageLockMode.ReadOnly, Obj.PixelFormat);
            unsafe
            {
        ...
        public Bitmap Displayimage()
        {
            ...
            unsafe
            {
                ...
                int offset = bitmapData1.Stride - (bitmapData1.Width * 4);
        ...
        public void ForwardFft()
        {
            ...
            FFT2D(ref Fourier, nx, ny, 1, out Output);
        }
        ...
        */
        ...
        public void FFT2D(ref COMPLEX[,] c, int nx, int ny, int dir, out COMPLEX[,] output)
        {
            int i, j;
